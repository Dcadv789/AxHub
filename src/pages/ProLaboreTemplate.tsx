        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-[#151515] rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-900">
            <div className="bg-gray-800 px-6 py-4">
              <h2 className="text-xl font-semibold text-white">Grupos de Informações</h2>
              <p className="text-gray-300 text-sm">Configure os grupos que serão exibidos no relatório</p>
            </div>
            <div className="p-6 space-y-4">
              {Object.entries(groupedFields).map(([group, groupFields]) => (
                <div key={group} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
                  <div className="flex items-center space-x-3">
                    <span className="text-xl">📊</span>
                    <div>
                      <p className="font-medium text-gray-900 dark:text-white">{getGroupTitle(group)}</p>
        ...
        <div className="space-y-6">
          {lastCalculation && (
            <div className="bg-white dark:bg-[#151515] rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-900">
              <div className="bg-gradient-to-r from-green-600 to-green-700 px-6 py-4">
                ...
                <p className="text-green-100 text-sm">Dados do último cálculo realizado</p>
              </div>
              <div className="p-6 space-y-4">
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600 dark:text-gray-400">Empresa:</span>
                    <span className="font-medium text-gray-900 dark:text-white">{companyName || 'Não informado'}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600 dark:text-gray-400">CNPJ:</span>
                    <span className="font-medium text-gray-900 dark:text-white">{cnpj || 'Não informado'}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-[#151515] rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-900">
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
              ...
              <p className="text-blue-100 text-sm">Dicas para um melhor resultado</p>
            </div>
            <div className="p-6">
