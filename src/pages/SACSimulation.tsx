...
export default function SACSimulation() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-[#151515] rounded-2xl shadow-md border border-gray-200 dark:border-gray-900">
        <div className="p-6 space-y-6">
          <h3 className="text-lg font-semibold text-gray-800 dark:text-white pb-2 border-b border-gray-100 dark:border-gray-700">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input
                ...
                disabled
                className="w-full px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md text-gray-700 dark:text-gray-300"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-xl border border-gray-200 dark:border-gray-700">
                  <h4 className="text-lg font-semibold text-gray-800 dark:text-white mb-4">Valores da Compra</h4>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 dark:text-gray-400">Valor Total do Bem:</span>
                      <span className="font-medium dark:text-white">{formatCurrency(totalPurchaseAmount)}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 dark:text-gray-400">Valor da Entrada:</span>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-medium dark:text-white">{formatCurrency(financedAmount)}</span>
                    </div>
                  </div>
                </div>
                <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-xl border border-gray-200 dark:border-gray-700">
                  <h4 className="text-lg font-semibold text-gray-800 dark:text-white mb-4">Custos do Financiamento</h4>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 dark:text-gray-400">Custo Total do Financiamento:</span>
                      <span className="font-medium dark:text-white">{formatCurrency(totals.payment)}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 dark:text-gray-400">Custo Total (com entrada):</span>
                      <span className="font-medium dark:text-white">{formatCurrency(totals.payment + Number(downPayment) / 100)}</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="overflow-x-auto rounded-xl border border-gray-200 dark:border-gray-700">
                  <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tfoot className="bg-gray-50 dark:bg-gray-800">
                      <tr>
                        <td className="px-6 py-3 text-sm font-medium text-gray-900 dark:text-white" colSpan={2}>Totais</td>
                        <td className="px-6 py-3 text-sm text-gray-900 dark:text-white">{formatCurrency(totals.payment)}</td>
                        <td className="px-6 py-3 text-sm text-gray-900 dark:text-white">{formatCurrency(totals.amortization)}</td>
                        <td className="px-6 py-3 text-sm text-gray-900 dark:text-white">{formatCurrency(totals.interest)}</td>
                        <td className="px-6 py-3 text-sm text-gray-900 dark:text-white">-</td>
                      </tr>
                    </tfoot>
                  </table>
                </div>
